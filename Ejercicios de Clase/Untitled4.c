/*
 Se tiene un listado de alumnos con Nombre y Apellido, nota  y numero de padron.
...
typedef char T_nombre_apellido[MAX_CARACTERES];
typedef T_nombre_apellido T_alumnos[MAX_ALUMNOS];
