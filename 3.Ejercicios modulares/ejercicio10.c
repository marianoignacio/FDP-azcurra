// 10) Escribir un programa que solicite el ingreso de un texto que será enviado
...
// puntuación: . , ; : ( )
// Los signos de puntuación no influyen en el costo.
// Para el cálculo de las palabras, considerar que una palabra estará separada de
// otra, por uno ó más blancos.
// Para el cálculo del importe a abonar, deberá considerar que cada palabra
// pagará $10 por cada 3 caracteres.
